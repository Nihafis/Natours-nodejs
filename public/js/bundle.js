...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</dib>");
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmlzZ3V4c29lMTIzIiwiYSI6ImNsc24wNHZyaDB0cnUybHIwb2liY2toMnIifQ.EO25G2TeorR5AyKJ7sbmIA';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51O1htGLgDbL3s63Y6ULqNXqxsyNcfk6RbOnNZiPY4iBE8V5wf2JnqIOZ25CJ8bCCWyQATBdUhmxdex45FhNywDzb00abHVIPbS'); // 1) Get checkout session from API
          _context.next = 4;
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(email, name, password, confirmPassword);
  });
}
if (loginForm) {
...
>>>>>>> e67cac6fbeb2dbabf46f5091f173705066789490
